...
<td valign="top" width="80%">
  <a href="https://arxiv.org/abs/2605.30774">
    <papertitle_just>CameraNoise: Enabling Faithful Camera Control in Video Diffusion through Geometry-Flow-Guided Noise Warping</papertitle_just>
  </a>
  <br>
...
<table class="talks-table" id="talks-main-table">
 ...
 <tr data-talk-cat="world-model">
    <td>NUS CEG5304 Deep Learning Guest Lecture (invited by <a href="https://xuyu0010.wixsite.com/xuyu0010">Yuecong Xu</a>)</td>
    <td>World Model and Agentic Video Generation</td>
    <td>11.2026<br>Singapore</td>
 </tr>
